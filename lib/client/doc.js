...
Doc.prototype.submitOp = function(component, options, callback) {
  ...
  // ZW: Allow ops to manually specify the document version they were
  // created against and their src/seq fingerprint
  if (options) {
    if (options.docVersion) {
      op.docVersion = options.docVersion;
    }
    if (options.opSrc) {
      op.src = options.opSrc;
    }
    if (options.opSeq) {
      op.seq = options.opSeq;
    }
  }
